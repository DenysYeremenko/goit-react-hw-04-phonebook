...
export class App extends Component {
  ...
  formSubmitHandler = newContact => {
    if((this.state.contacts.findIndex(contact => contact.name.toLocaleLowerCase() === newContact.name.toLocaleLowerCase())) >= 0) {
  ...
  render () {
    ...
    <h2 className={style.contactsHeader}>Contacts</h2>
      ...
      <ContactList contacts={this.filteredContacts()} onDeleteContact={this.onDeleteContact}/>
    </>
    );
  }
};